...
{
    public class AddDropCommand : BaseCommandModule
    {
        public DataBase database;

        [Command("adddrop")]
        [Description("Permite adicionar um drop para um monstro.")]
        [Usage("adddrop <monstro> <item> <chance> <quantidade minima> <quantidade máxima>")]
        [RequireOwner]
        public async Task AddDropCommandAsync(CommandContext ctx, string monsterIdString, string itemIdString, double chance, int quantMin, int quantMax)
        {
