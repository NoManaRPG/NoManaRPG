...
namespace WafclastRPG.Commands.UserCommands
{
    ...
    public class CombatCommands : BaseCommandModule
    {
        ...
        public CombatCommands(IPlayerRepository playerRepository, IZoneRepository zoneRepository, IMongoSession session, UsersBlocked usersBlocked)
        {
        ...
        //    WafclastZone room = new ();
        //    var monster = room.Monsters;
        //    if (monster == null)
        ...
        //    str.AppendLine($"Você encontrou **[{room.Monsters.Mention}]!**");
        ...
        //      var character = player.Character;
        //      character.Room = await _zoneRepository.FindRoomOrDefaultAsync(character.Room.Id);
