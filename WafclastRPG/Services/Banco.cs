...
namespace WafclastRPG.Services
{
    public class Banco
    {
        ...
        public IMongoCollection<TesteEntiti> Testes { get; }
        public Banco()
        {
            Cliente = new MongoClient();
            Database = Cliente.GetDatabase("Wafclast");
            Jogadores = Database.CriarCollection<RPJogador>();
            Testes = Database.CriarCollection<TesteEntiti>();
