...
namespace TorreRPG.Metadata.Itens.Armas.UmaMaoArmas
{
    public class MacasUmaMao
    {
        ...
        => new RPMacaUmaMao(1, "Clava de Madeira Balsa", RPClasse.MacaUmaMao, 6, new RPDano(6, 8), 0.05, 1.45, 14);

        public RPMacaUmaMao MacaUmaMao2()
        => new RPMacaUmaMao(1, "Clava Tribal", RPClasse.MacaUmaMao, 6, new RPDano(8, 13), 0.05, 1.4, 26);

        public RPMacaUmaMao MacaUmaMao3()
        => new RPMacaUmaMao(10, "Clava Cravada", RPClasse.MacaUmaMao, 6, new RPDano(13, 16), 0.05, 1.45, 41);
    }
}
